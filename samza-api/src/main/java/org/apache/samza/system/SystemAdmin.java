...
public interface SystemAdmin {
  ...
  String PARTITION_COUNT = "partitionCount"; // TODO better place for this property name
   ...
   */
  default void createStream(String streamName, Config streamConfig) {
    int numOfPartitions = streamConfig.getInt(PARTITION_COUNT, -1);

    if (numOfPartitions >= 0) {
      createChangelogStream(streamName, numOfPartitions);
    }
  }
